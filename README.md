...
4. **Нажмите «Очистить».**
   - Если открыт браузер (или Discord, Steam и т. п.), программа предложит его закрыть:
     кэш открытой программы почистить нельзя. «Да» закроет программу (браузер восстановит
     вкладки при следующем запуске), «Нет» пропустит её кэш.
...
| Кэш браузеров | Папки кэша Chrome, Edge, Яндекс Браузера, Opera / Opera GX, Brave, Vivaldi, Chromium, Firefox — во всех профилях браузера | Сайты при первом заходе откроются чуть медленнее. Пароли, история, закладки, cookies, вкладки не затрагиваются |
...
- Пароли, cookies, историю, закладки, расширения и открытые вкладки браузеров.
...
- **Закрытие программ.** Сначала вежливо, как крестиком окна. Если за 8 секунд программа не
  закрылась, процесс завершается принудительно.
